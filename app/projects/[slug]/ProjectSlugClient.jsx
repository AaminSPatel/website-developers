      ...
      <header className="bg-muted/30 py-16 md:py-24 border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            <Badge
              variant="secondary"
              className="mb-4 text-sm px-3 py-1 uppercase tracking-wide"
            >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              How we helped {project.clientName || "our client"} achieve digital
              success.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                href={`https://wa.me/${contact.phone.replace(/\D/g, "")}?text=${encodeURIComponent(`Hi, I saw the ${project.headline} case study. I'm interested in a similar website.`)}`}
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          >
            ...
            <div className="text-lg text-muted-foreground leading-relaxed">
              {project.problem ? (
                ...
                <p>
                  The client needed a robust digital solution to overcome
                  operational inefficiencies and improve their online visibility
            ...
            <div className="text-lg text-muted-foreground leading-relaxed">
              {project.solution ? (
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground">
                  <p>
                    We implemented a custom Next.js solution focusing on speed,
                    SEO, and user conversion.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {project.results ? (
                ...
                <p className="text-center w-full">
                  Project delivered successfully with high client satisfaction.
                </p>
              )}
            </div>
          </motion.div>
      ...
      <section className="py-20 bg-muted/30 border-t border-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Let's build a high-performance website for your business.
          </p>
