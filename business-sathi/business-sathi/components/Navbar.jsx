      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div
          className={`flex items-center justify-between rounded-full px-5 py-3 transition-all duration-500 ${
            scrolled ? "glass shadow-[0_8px_30px_rgba(17,17,17,0.08)]" : ""
          }`}
        >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="lg:hidden mx-4 mt-2 rounded-3xl glass shadow-[0_20px_50px_rgba(17,17,17,0.15)] overflow-hidden"
          >
